...
| Celebración: cumpleaños, despedida, aniversario, corporativo | Ver regla de celebración abajo |
...
**Regla de celebración — prioridad sobre el flujo base:**
Cuando el cliente menciona una celebración (despedida de soltero, cumpleaños, aniversario, evento corporativo) y ya se conoce el número de pasajeros:
1. PRIMERO mencionar el upgrade premium como opción destacada.
2. DESPUÉS presentar el precio del bote base como alternativa accesible.
No ejecutar el flujo estándar de recomendación por capacidad sin antes ofrecer el upgrade. La señal de celebración tiene prioridad sobre la tabla de pasajeros.
...
- Si el cliente pide explícitamente algo más íntimo o más pequeño, bajar **exactamente un nivel** en la jerarquía. No más.
- Ejemplo de bajada correcta: si el cliente está en Azimut 70 y pide algo más íntimo, ofrecer Azimut 62. No saltar a Azimut 58 ni a Azimut 55.
